...
export const zh_CN: TranslationMap = {
  ...
  remoteTerminal: {
    ...
    heading: "ComfyUI 服务器",
    description:
      "保存 SSH 连接信息，复制可直接执行的命令，并通过网关打开经过身份验证的浏览器终端。",
    form: {
      title: "新增 SSH 配置",
      subtitle: "连接信息保存在当前浏览器中。使用密码登录时，私钥路径可留空。",
      name: "配置名称",
      sshConfigHost: "SSH 配置别名",
      host: "主机或 IP",
      port: "端口",
      forwardPort: "远程服务端口",
      forwardPortHelp:
        "服务器上远程服务（例如 ComfyUI）的端口。会自动转发并通过 /remote-terminal/proxy 暴露。默认 6006。",
      username: "用户名",
      privateKeyPath: "私钥路径",
      privateKeyPathPlaceholder: "可选，例如 ~/.ssh/id_ed25519",
      password: "密码",
      passwordPlaceholder: "可选 SSH 密码",
      passwordHelp: "仅用于在浏览器终端中应答 SSH 登录提示。",
      description: "描述",
      descriptionPlaceholder: "生产 Web 节点、预发机或跳板机备注…",
      save: "保存服务器",
    },
    profile: {
      title: "已保存的服务器",
      subtitle: "点击某个配置开启 SSH 会话。",
      add: "新增服务器",
      empty: "暂无远程服务器。",
      connect: "连接",
      delete: "删除",
      connectTitle: "通过 SSH 连接",
      forwardPort: "远程服务端口：{port}",
      deleteConfirmTitle: "删除此服务器？",
      deleteConfirmBody: "将从此浏览器的已保存服务器中移除 {name}。",
      neverConnected: "从未连接",
    },
    commands: {
      title: "SSH 命令",
      subtitle: "可在本地直接使用生成的命令，或通过下方内嵌终端连接。",
      copyCommand: "复制命令",
      copyConfig: "复制配置",
      commonTitle: "密钥配置",
      configTitle: "~/.ssh/config 片段",
      example: "示例服务器",
    },
    terminal: {
      title: "实时终端",
      ...
      disconnect: "断开",
      send: "发送",
      empty: "选择一个已保存的服务器以开启终端会话。",
      connectingLine: "正在连接 {target}。",
      socketOpenLine: "WebSocket 已连通，正在启动 SSH 会话…",
      statusLine: "远程终端状态更新。",
      readyLine: "SSH 进程已启动，等待 SSH 输出 / 认证结果显示在下方。",
      serviceReadyLine: "远程服务代理已就绪，点击“打开远程服务”按钮访问端口 {port} 上的服务。",
      openService: "打开远程服务（:{port}）",
      openServiceTitle: "通过网关代理打开远程服务（端口 {port}）。",
      openComfyUi: "打开 ComfyUI",
      openComfyUiTitle: "在新标签页中打开 ComfyUI（:{port}）。",
      useForComfyUi: "用于 ComfyUI",
      useForComfyUiApplying: "应用中…",
      useForComfyUiTitle: "将内嵌 Pixelle 后端指向 {url}，以便访问服务器上的 ComfyUI。",
      useForComfyUiNoBind: "此通道当前没有可用的本地绑定地址，请重新连接后再试。",
      useForComfyUiStartLine: "正在将 ComfyUI 配置接入 {url}…",
      useForComfyUiWroteLine: "已写入 ComfyUI 地址：{url}。",
      useForComfyUiFailedLine: "ComfyUI 配置接入失败：{error}",
      useForComfyUiRestartedLine: "已请求重启 Pixelle 后端，ComfyUI 地址将很快生效。",
      useForComfyUiRestartSkippedLine:
        "配置已保存，请手动重启 Pixelle 后端以应用新的 ComfyUI 地址。",
      retryApply: "重试应用",
      retryApplyTitle: "使用绑定地址 {url} 重新执行 Pixelle 接入流程。当自动流程失败时使用。",
      comfyUiPhaseIdle: "ComfyUI 空闲",
      comfyUiPhaseChecking: "正在检查 ComfyUI",
      comfyUiPhaseStarting: "正在启动 ComfyUI",
      comfyUiPhaseWaiting: "等待 ComfyUI",
      comfyUiPhaseReady: "ComfyUI 已就绪",
      comfyUiPhaseApplying: "正在应用到 Pixelle",
      comfyUiPhaseActive: "Pixelle 正在使用",
      comfyUiPhaseFailed: "ComfyUI 启用失败",
      comfyUiCheckingLine: "正在通过 SSH 通道检查远程 ComfyUI…",
      comfyUiStatusLine: "ComfyUI 启用状态更新。",
      comfyUiReadyAlreadyLine: "远程 ComfyUI 已在运行。",
      comfyUiReadyStartedLine: "远程 ComfyUI 启动成功。",
      comfyUiApplyingLine: "正在将 Pixelle 指向 {url}…",
      comfyUiActiveLine: "Pixelle 已切换到 {url} 的 ComfyUI。",
      comfyUiEnsureFailedGeneric: "无法自动启用 ComfyUI。",
      comfyUiEnsureFailedLine: "[ComfyUI] 自动启用失败：{error}",
      comfyUiWaitingSshLine: "等待 SSH 认证完成后再检查 ComfyUI…",
      comfyUiRetryWaitingLine: "通道尚未激活，几秒后将重试 ComfyUI 启用…",
      connectTimeoutLine: "SSH 会话就绪前连接已超时。",
      socketClosedLine: "终端 WebSocket 已关闭，代码 {code}{reason}。",
      disconnectedLine: "终端已断开。",
      socketError: "终端 WebSocket 错误。",
      inputPlaceholder: "systemctl status nginx",
    },
    quickCommands: {
      label: "常见命令：",
      ariaLabel: "ComfyUI 快捷命令",
      enableProxy: "开启代理",
      startComfyUi: "启动 ComfyUI",
    },
    messages: {
      required: "请填写配置名称，并至少提供主机 / IP 或 SSH 配置别名。",
      saved: "已保存 {name}。",
      deleted: "已删除 {name}。",
      copied: "已复制到剪贴板。",
      copyFailed: "剪贴板复制失败。",
      commandReady: "正在连接 {name}。",
    },
  },
  videoStudio: {
    heading: "Pixelle-Video",
    topic: {
      title: "主题",
      titleLabel: "标题",
    ...
    state: {
      notInstalled: "Pixelle-Video后端尚未安装。",
      install: "安装Pixelle-Video",
      idle: "Pixelle-Video后端已安装，尚未启动。",
      start: "启动Pixelle-Video",
      starting: "正在启动Pixelle-Video后端…",
      backendError: "视频后端启动失败。",
      idleAutoStopped: "长时间未使用，视频后端已自动暂停。",
      restart: "重启后端",
      viewLogs: "查看日志",
      featureDisabled: "当前构建未启用Pixelle-Video。",
    },
  },
  overview: {
    access: {
  ...
  remotionStudio: {
    ...
    description:
      "用本地 Remotion 打包器渲染基于 React 的视频模板。模板目录在 plugins.entries.remotion.config.templateRoots 中声明。",
    state: {
      disabled: "Remotion 插件未启用或未配置。",
      disabledHint: "在 ~/.openclaw/openclaw.json 的 plugins.entries.remotion 下启用并重启网关。",
      noTemplates: "在已配置的 templateRoots 中未发现模板。",
      noTemplatesHint: "每个 templateRoot 需要在 <root>/src/index.ts 提供 Remotion 入口。",
    ...
    template: {
      compositions: "Composition 列表",
      composition: "Composition",
      empty: "请在左侧选择模板。",
      sizeBadge: "{width}×{height} · {fps}fps · {duration}帧",
    },
    form: {
      schemaForm: "表单",
      jsonMode: "JSON",
      ...
      schemaTooComplex: "Schema 包含尚未支持的字段，已回退到 JSON 输入。",
    },
    job: {
      status: {
        queued: "排队中",
      ...
      durationLabel: "耗时",
      sizeLabel: "大小",
      mediaLibraryLabel: "媒体库",
      copyPath: "复制路径",
      copyMediaPath: "复制媒体库路径",
    },
    preview: {
      empty: "渲染完成后将在这里预览。",
      videoUnsupported: "无法内嵌预览。请通过上方路径打开文件。",
    },
    history: {
      empty: "暂无最近的任务。",
    },
