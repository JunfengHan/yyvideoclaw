...
> &
  Pick<CronModelSuggestionsState, "cronModelSuggestions"> & {
    ...
    remotionStatus: import("./controllers/remotion-studio.js").RemotionStatusWire | null;
    remotionStatusError: string | null;
    remotionTemplates: readonly import("./controllers/remotion-studio.js").RemotionTemplateWire[];
    ...
    remotionDraft: import("./controllers/remotion-studio.js").RemotionStudioDraft;
    remotionCurrentJob: import("./controllers/remotion-studio.js").RemotionJobResponseWire | null;
